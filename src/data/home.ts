...
import appHome from "../assets/home/images/app-home.webp";
import demoLuxury from "../assets/home/images/demo-luxury.webp";
import demoTech from "../assets/home/images/demo-tech.webp";
import demoClassic from "../assets/home/images/demo-classic.webp";
import demoFresh from "../assets/home/images/demo-fresh.webp";
import scenePreview from "../designs/images/scene-preview.webp";
import dashboardPreview from "../designs/images/dashboard-preview.webp";
...
export const faqs: Faq[] = [
  {
    question: "云购系统源码包含哪些页面？",
    answer:
      "覆盖核心前端页面场景：首页展示（搜索栏、轮播图、功能入口、商品卡片）、商品展示（商品详情、参与记录、进度条、状态标签）、活动展示（大转盘、限时揭晓、新品首发、专题活动）以及咨询转化入口（报价按钮、客服入口、联系方式复制）。",
  },
  {
    question: "支持多语言展示吗？",
    answer:
      "支持。轻奢标准版提供多语言视觉与全球市场风格展示，另有经典基础版（单语言视觉）、奢享科技版（品牌化 UI）和新颖主题版（换肤展示）可供选择，也提供多语言文案整理增值服务。",
  },
  {
    question: "价格是多少，支持 USDT 支付吗？",
    answer:
      "基础版 ¥3800（约 560 USDT）、标准版 ¥6800（约 980 USDT）、科技版 ¥8800（约 1290 USDT）。增值服务包括页面定制 ¥1200（168 USDT）、APP 页面适配 ¥1600（224 USDT）、多语言文案整理 ¥600（84 USDT）、品牌视觉调整 ¥100（14 USDT）起。",
  },
  {
    question: "可以按需定制页面和视觉吗？",
    answer:
      "可以。提供页面定制、APP 页面适配、多语言文案整理、品牌视觉调整等增值服务，前端制作流程为：需求确认、页面设计、页面制作、预览确认。",
  },
  {
    question: "如何联系咨询和获取报价？",
    answer: "可通过 Telegram 咨询、复制微信联系客服，或直接点击网站内的获取报价按钮。",
  },
  {
    question: "页面是否包含后台运营系统？",
    answer:
      "本网站以静态前端页面和交互展示为主，用于投放推广、产品介绍和对外演示；页面内容仅用于产品展示和方案介绍，实际业务运营前请自行确认当地关于抽奖、积分、营销活动、数据隐私等法规要求。",
  },
];
